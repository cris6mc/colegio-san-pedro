        ...
        <div className="justify-center items-center w-[800px]">
          <h1 className="text-[1rem] text-justify w-[800px]">
            ...
            <p className="mt-[2rem]">
              ...
              aprendizaje y crecimiento. Nuestra misión es formar estudiantes
              autónomos y competentes, preparados para satisfacer las
              necesidades y expectativas de la sociedad, promoviendo valores de
              identidad, respeto y responsabilidad (Misión de la IE N° 30073){" "}
              <br />
              <br />
              ...
              Educativa N° 30073 San Pedro de Yauyo Chupaca es un referente en

...
function CardLapbook({ ImageSRC, Title, Author, Grade, Description }) {
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-600 text-sm text-center">Autor: {Author} &nbsp; Grado: {Grade}</p>

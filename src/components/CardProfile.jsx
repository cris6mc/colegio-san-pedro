...
function CardProfile({ nombre, image, cargo, telefono, email }) {
  return (
    <div className="flex flex-col border rounded-lg justify-center items-center px-2 py-6 hover:bg-gradient-to-r from-gray-200 to-blue-100 min-h-[230px] max-h-[30vh] md:max-h-80">
